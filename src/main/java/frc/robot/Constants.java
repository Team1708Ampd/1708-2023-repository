...
public final class Constants {
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(35.42);
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(335.70);
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(61.72);
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(351.89);
}
