...
public class ArmTelescopingSubsystem extends SubsystemBase {
  ...
  public ArmTelescopingSubsystem(int talonDeviceNum1)
  {
  ...
  public ArmTelescopingSubsystem(int talonDeviceNum1,  TalonFXConfiguration motorConfig) {
  ...
  public ArmTelescopingSubsystem withTalonConfig(TalonFXConfiguration motorConfig)
  {
    // Update the config
